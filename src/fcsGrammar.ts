...
const grammarNodes : GrammarType[] = [
    ...
    new GrammarType({ dot : 2, key : "Fcs.Reporting.RendererHtml", kind : GrammarKind.Function }),
    new GrammarType({ dot : 2, key : "Fcs.Reporting.RendererText", kind : GrammarKind.Object }),
